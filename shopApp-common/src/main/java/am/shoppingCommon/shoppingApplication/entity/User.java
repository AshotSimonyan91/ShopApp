...
public class User {
    ...
    private int id;
    @NotNull
    @Size(min = 0,max = 15,message = "Name length it should be min 2 max 15 characters")
    @Column(nullable = false)
    private String name;
    @NotNull
    @Size(min = 0,max = 15,message = "Surname length it should be min 2 max 15 characters")
    @Column(nullable = false)
